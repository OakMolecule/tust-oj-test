...
///////////////////////////MAIN	
	...
	if (!$result){
		...
		$view_news.= "<tr><td width=20%><td>This <a href=http://cm.baylor.edu/welcome.icpc>ACM/ICPC</a> OnlineJudge is a GPL product from <a href=https://github.com/Tust-Celitea/tustoj>tustoj</a></tr>";
		$view_news.= "</table>";
	}
$view_apc_info="";
